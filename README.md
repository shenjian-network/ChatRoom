...
**所有用户**共同维护一个收发信息表，并保留适当的索引，需要时在里面选取
...
| 3 |2018.12.13 13:44| liuyitao | 1  |doc |
| 4 |2018.12.13 13:44| liuyitao | 2  |doc |
</br>

>注：文件类型通过后缀直接判断即可，若为msg则表示发送消息；在这里文件只区分文本和非文本（后面详做考虑看能否合并）
